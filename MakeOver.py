...
def makeOver():
    ...
    background = pygame.image.load("Assets/room.jpg")
    ...
    beret = pygame.image.load("Assets/beret.png")
    lunettes = pygame.image.load("Assets/lunettes.webp")
    moustache = pygame.image.load("Assets/moustache.webp")
    bulles = [pygame.image.load("Assets/bulle" + colors + ".webp") for colors in ["Jaune", "Rose", "Verte", "Grise", "Bleue"]]
    ...
    accessories = [
        {"image": beret, "pos": (1850, 100)},
        {"image": lunettes, "pos": (1850, 220)},
        {"image": moustache, "pos": (1850, 340)},
        {"image": bulles[0], "pos": (1850, 460)},
        {"image": bulles[1], "pos": (1850, 580)},
        {"image": bulles[2], "pos": (1850, 700)},
        {"image": bulles[3], "pos": (1850, 820)},
        {"image": bulles[4], "pos": (1850, 940)}
    ]
    ...
    while running:
        ...
        if menu_visible or menu_x < 2000:
            pygame.draw.rect(screen, (50, 50, 50), (menu_x, 0, 400, screen.get_height()))
            for accessory in accessories:
                screen.blit(accessory["image"], (menu_x + 50, accessory["pos"][1]))
